...
class GajiModalPengeluaranResource extends Resource
{
    ...
    // ----------hidden gajimodalpengeluaran jika tidak memiliki akses
    public static function shouldRegisterNavigation(): bool
    {
        if(auth()->user()->can('gajimodalpengeluaran'))
            return true;
        else
            return false;
    }

    // ----------hidden akses url /gajimodalpengeluaran jika tidak memiliki akses
